...
const properties = [
  ...
  },
  {
    ...
    region: 'Ingleses',
    description:
      'IMÓVEL COM MATRÍCULA Apartamento de 3 dormitórios, com uma suíte, a uma quadra do mar, em frente a uma linda praça, muito arborizada, com separado para pets. 3 banheiros, sendo um lavabo, living, duas salas amplas de jantar e estar (com TV), escritório, cozinha medida, lavanderia sob medida, uma sacada ampla e integrada. Informações sujeitas a alterações sem aviso prévio',
    price: 'R$ 890.000,00',
    details: {
      square: '114,90 m²',
      rooms: '3',
  ...
  },
  {
    ...
    region: 'Ingleses',
    description:
      'IMÓVEL COM MATRÍCULA (em processo de individualização) O empreendimento será localizado na região nobre da praia dos Ingleses (região da Rua das Gaivotas), Norte da Ilha Florianópolis, num terreno de aproximadamente 20.000,00m², a 180m do mar, na Rua dos Canudos. São 8 blocos, divididos em terrenos, com estrutura de lazer individual em cada terreno. Conta com uma ampla infraestrutura de lazer aprox. 4.500m². piscina, salão de festas, academia, brinquedoteca, playground, churrasqueiras, pet place e pista de caminhada. Está com móveis de altíssima qualidade. Informações sujeitas a alterações sem aviso prévio',
    price: 'R$ 750.000,00',
    details: {
      square: '80,97 m²',
      rooms: '2',
  ...
  },
  {
    ...
    region: 'Ingleses',
    description:
      'IMÓVEL COM MATRÍCULA Reformado! Localizado na rua Martinho de Haro. São 2 dormitórios, semimobiliados, com vaga de garagem coberta. Posição solar quartos Oeste. Rua calçada e próximo a ponto de ônibus. Informações sujeitas a alterações sem aviso prévio',
    price: 'R$ 415.000,00',
    details: {
      square: '57,00 m²',
      rooms: '2',
  ...
  },
  {
    ...
    region: 'Jurerê',
    description:
      'IMÓVEL COM MATRÍCULA (em processo de individualização) Belíssimo apartamento de Alto Padrão na praia de Jurerê. Excelente localização em frente as marinas e próximo a paradisíaca de Canasjurê. Apartamento de um dormitório, suíte, conta com um lavabo, sala e cozinha com churrasqueira. O condomínio é e de muitíssimo bom gosto. Conta com academia, sala de jogos, salão de festas, fogo de chão e piscina. Informações sujeitas a alterações sem aviso prévio',
    price: 'R$ 636.000,00',
    details: {
      square: '43,36 m²',
      rooms: '1',
